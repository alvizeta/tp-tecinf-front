export default {
  error: {
    ...
    login: {
      blocked_user: 'El user se encuentra bloqueado.',
      ...
      'lock.invalid_username_password': 'User y contraseña inválidos.',
      ...
      'lock.mfa_registration_required':
        'Se requiere autenticación de dos factores. Por favor registre su product antes de continuar.',
    ...
    signUp: {
      ...
      password_no_user_info_error: 'La constraseña es similar a los datos del user.',
      password_strength_error: 'La contraseña es muy débil.',
      user_exists: 'El user ya existe.',
      username_exists: 'El nombre de user se encuentra en uso.'
    }
  },
  success: {
  ...
  usernameInputPlaceholder: 'su user',
  usernameOrEmailInputPlaceholder: 'user/correo electrónico',
  title: 'Auth0',
